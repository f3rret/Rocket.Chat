...
const Extended = ({
	...
	return (
		<Sidebar.Item style={{paddingRight: 5}}
			...
			<Sidebar.Item.Content>
				<Sidebar.Item.Content>
					<Sidebar.Item.Wrapper>
						...
						>
							{title}
							{phone && <b style={{position: 'absolute', marginLeft: '10px', fontSize: '85%', color: 'tan', opacity: '0.75'}} className="icon-phone-squared">{phone}</b>}
						</Sidebar.Item.Title>
