...
function UserTable({ workspace = 'local' }) {
	...
	const renderRow = useCallback(
		({ createdAt, emails, _id, username, name, domain, bio, phone, avatarETag, nickname }) => (
			<Table.Row
				key={_id}
						...
						<Box>
							...
							<Box withTruncatedText grow={1} mi='x8'>
								<Box display='flex'>
									...
									{phone && <Box><b style={{fontSize: '85%', marginLeft: '20px'}} className="icon-phone-squared">{phone}</b></Box>}
								</Box>
