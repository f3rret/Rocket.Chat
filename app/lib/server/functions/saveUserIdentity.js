...
export function saveUserPhone(_id, newNumber){
	...
	const previousNumber = user.phone;
	const numberChanged = previousNumber !== number;
	...
	user.phone=number;
	//Rooms.replacePhoneOfUserByUserId(user._id, user.phone);
	//Subscriptions.setPhoneByUserId(user._id, user.phone);
	Subscriptions.updateDirectPhoneByName(user.username, user.phone);
